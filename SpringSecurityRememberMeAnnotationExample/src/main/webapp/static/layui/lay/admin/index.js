...
;layui.extend({setter: "admin/config", admin: "admin/admin", view: "admin/view"}).define(["setter", "admin"], function (a) {
    ...
    r(window);
    n.screen() < 2 && n.sideFlexible(), layui.config({base: e.base + "admin/"}), layui.each(e.extend, function (a, i) {
        var n = {};
        n[i] = "{/}" + e.base + "admin/" + i, layui.extend(n)
